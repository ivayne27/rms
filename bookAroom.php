...
if(isset($_POST['booknow'])){
 ...
 $days = dateDiff($_POST['departure'],$_POST['departure']); 

if($days <= 0){
  $msg = 'Available today';
}else{
   $msg =  'Available room From:'.$_POST['departure']. ' To: ' .$_POST['departure'];

} 


$_SESSION['arrival'] = date_format(date_create( $_POST['departure']),"Y-m-d");
$_SESSION['departure'] =date_format(date_create($_POST['departure']),"Y-m-d");
$_SESSION['client_name'] = $_POST['client_name'];
$_SESSION['lname'] = $_POST['lname'];
$_SESSION['mnumber'] = $_POST['contact_number'];
$_SESSION['addressNew'] = $_POST['address'];
...
// filtering the rooms
 // ======================================================================================================
                    $mydb->setQuery("SELECT * FROM `tblreservation`     WHERE ((
                        ...
                        OR (
                        DATE_FORMAT(`ARRIVAL`,'%Y-%m-%d') >=  '$departure'
