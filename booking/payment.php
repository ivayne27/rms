...
try {
    ...
    for ($i=0; $i < $count_cart  ; $i++) { 
            ...
            $cnameApplied =  $_SESSION['client_name'] . ' '. $_SESSION['lname'];
      ...
      $sql = "INSERT INTO `tblpayment` (`TRANSDATE`,`CONFIRMATIONCODE`,`PQTY`, `GUESTID`, `SPRICE`,`MSGVIEW`,`STATUS`,`client_name`,`number`,`address`)
       VALUES ('" .date('Y-m-d h:i:s')."','" . $_SESSION['confirmation'] ."',".$item."," . $_SESSION['GUESTID'] . ",".$tot.",0,'Pending','" .$cnameApplied."','" . $_SESSION['mnumber'] ."','" . $_SESSION['addressNew'] ."')" ;
      $mydb->setQuery($sql);
      $mydb->executeQuery(); 
  ...
  <div class="row">
    <div class="col-md-8 col-sm-4">
       <div class="col-md-12">
          ...
          <label>Name:</label>
          <?php echo $_SESSION['client_name'] . ' '. $_SESSION['lname'];
           ?>
        </div>
        <div class="col-md-12">
          <label>Address:</label>
