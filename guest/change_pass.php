              ...
              <div class="table-responsive mailbox-messages">
                ...
                <div class="form-group">
                     ...
                     <div class="form-group">
                      <div class="col-md-10">
                        <label class="col-md-4 control-label" for=
                        "oldpass">Old Password:</label>

                        <div class="col-md-8">
                          <input name="oldpass" type="password" class="form-control input-sm" id="oldpass" />
                        </div>
                      </div>
                    </div> 
                    <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input name="newpassword" type="password" class="form-control input-sm" id="newpassword" />
                        </div>
                      </div>
                    </div> 
                    <div class="form-group">
                      <div class="col-md-10">
                        <label class="col-md-4 control-label" for=
                        "confirmpass">Confirm Password:</label>

                        <div class="col-md-8">
                          <input name="confirmpass" type="password" class="form-control input-sm" id="confirmpass" />
                        </div>
                      </div>
                    </div> 
