...
<thead>
<tr><td colspan="9" align="center"><h1 class="page-header">Nixie's Mountain Resort</h1></td></tr>
<tr bgcolor="#999999">
...
if(isset($_POST['submit'])){
	...
	$sql ="SELECT  `client_name`,`G_FNAME`, `G_LNAME`,`ARRIVAL`, `DEPARTURE`,`ROOM`,`ROOMDESC` ,`PRICE` ,`RPRICE`,`STATUS`
